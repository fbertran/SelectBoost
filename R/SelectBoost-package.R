...
#' existing variable selection method. This algorithm is based on highly intensive simulations and #' takes into account the correlation structure of the data. Our algorithm can either produce a
